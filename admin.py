...
class EmailUserAdmin(UserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'is_superuser', 'is_seller', 'is_buyer', 'is_seller_approved')
    ...
    fieldsets = (
        ...
        ('Personal info', {'fields': ('first_name', 'last_name',
                                      ...
                                      'address_line_1', 'address_line_2', 'postal_code', 'profile_description')}),
        ('Location', {'fields': ('country', 'state', 'city')}),
        ('Permissions', {'fields': ('is_seller_approved', 'is_seller', 'is_buyer', 'is_superuser', 'validated_at')}),
        ('Company Details', {'fields': ('company_name', 'company_country', 'ABN', 'company_logo', 'background_image')}),
    )
...
class CountryAdmin(admin.ModelAdmin):
    list_display = ('name', 'group_country', 'country_code', 'currency_symbol', 'weight_format', 'braintree_merchanr_id', 'rate')
