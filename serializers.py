...
class EmailUserSerializer(UserSerializer):
    class Meta:
        model = EmailUser
        fields = ('first_name', 'last_name', 'email', 'is_buyer', 'is_seller', 'image')
...
class CreateEmailUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = EmailUser
        fields = ('first_name', 'last_name', 'email', 'company_name', 'ABN', 'company_country',
                 'is_buyer', 'is_seller', 'image', 'password',
                 'is_terms_conditions_accepted','terms_conditions', 'token')
